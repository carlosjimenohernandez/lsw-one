...
require(resolve("dev/bundlers/core/vuebundler.js")).bundle({
  ...
  output: __dirname + "/lsw-data-explorer.components.js",
  ignore: [],
});
...
require(resolve("dev/bundlers/core/htmlbundler.js")).bundle({
  ...
  output: __dirname + "/lsw-data-explorer.js",
  ignore: [],
  wrap: false,
});
...
require(resolve("dev/bundlers/core/htmlbundler.js")).bundle({
  ...
  output: __dirname + "/lsw-data-explorer.css",
  ignore: [],
  wrap: false,
});
...
Set_license: {
  ...
  prependFileSync(__dirname + "/lsw-data-explorer.css", licenseSource, "utf8");
  prependFileSync(__dirname + "/lsw-data-explorer.js", licenseSource, "utf8");
}